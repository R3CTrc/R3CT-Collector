...
public class FabricPlatformHelper implements IPlatformHelper {
    ...
    public void sendClaimRewardPacketToServer(String tabId) {
        net.fabricmc.fabric.api.client.networking.v1.ClientPlayNetworking.send(new com.r3ct.collection.network.ClaimCategoryRewardPayload(tabId));
    }
    ...
    public void sendRequestLeaderboardPacketToServer() {
        net.fabricmc.fabric.api.client.networking.v1.ClientPlayNetworking.send(new com.r3ct.collection.network.RequestLeaderboardPayload());
    }
    ...
    public void sendLeaderboardDataPacketToClient(net.minecraft.server.level.ServerPlayer player, java.util.List<com.r3ct.collection.network.LeaderboardDataPayload.TopPlayerEntry> entries) {
        net.fabricmc.fabric.api.networking.v1.ServerPlayNetworking.send(player, new com.r3ct.collection.network.LeaderboardDataPayload(entries));
    }
